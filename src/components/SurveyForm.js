...
//   let dataMessage = document.getElementsByClassName('data');

//   dataMessage.oninvalid = function(event){
//     event.target.setCustomValidity("Veri girmek zorunludur.")
//   }
...
//                 value={min}
//                 placeholder="Minimum"
//                 title="Please,enter the minimum number!"
//               />
